List of available loggers for use with or the log message functions such as or . The list of available loggers, along with the current logging level, can be retrieved via the macro function .
