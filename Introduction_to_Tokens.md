...
2.  In the chat window, enter **/tsay (ID)**, where “(ID)” is replaced by the actual ID of the speech item. So if you wanted to howl your battlecry - which you've cleverly given the ID “bcry” - you would select your token, and enter **/tsay bcry** in the chat window.
