...
Como habeís podido ver en [Introduccion a la creacion de mapas](Introduction_to_Mapping/es "wikilink"), MapTool te permite crear mapas virtuales y “miniaturas” (Conocidas en la jerga del MapTool como [tokens](Introduction_to_Tokens/es "wikilink")) para usarlo en partidas de rol, de un modo muy similar a como tendrías estos en un tablero. Por esta razón el MapTool también es conocido como “virtual tabletop,” o “VTT.” En esta guía, veremos lo fundamental de como compartir un mapa con otras personas a través de internet.
...
{{\#customtitle:Introducción a Hospedaje de Juego(inacabado)|Introducción a Hospedaje de Juego(inacabado)}}
