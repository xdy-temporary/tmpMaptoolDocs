This section expects that you are already familiar with how to add [macro buttons](Introduction_to_Macro_Writing "wikilink") to the MapTool user interface. __TOC__
