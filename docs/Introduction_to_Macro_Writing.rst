...
.. container::
   ...
   .. container::
      ...
      .. container::
         ...
         -  `Log
            in </maptool/index.php?title=Special:UserLogin&returnto=Introduction+to+Macro+Writing>`__
      ...
      .. container::
         ...
         .. container:: vectorTabs
            ...
            -  `Read </rptools/wiki/Introduction_to_Macro_Writing>`__
            -  `View
               source </maptool/index.php?title=Introduction_to_Macro_Writing&action=edit>`__
            -  `View
               history </maptool/index.php?title=Introduction_to_Macro_Writing&action=history>`__
   ...
   .. container::
      ...
      .. container:: portal
         ...
         .. container:: body
            ...
            -  `What links
               here </rptools/wiki/Special:WhatLinksHere/Introduction_to_Macro_Writing>`__
            -  `Related
               changes </rptools/wiki/Special:RecentChangesLinked/Introduction_to_Macro_Writing>`__
            -  `Special pages </rptools/wiki/Special:SpecialPages>`__
            -  `Printable
               version </maptool/index.php?title=Introduction_to_Macro_Writing&printable=yes>`__
            -  `Permanent
               link </maptool/index.php?title=Introduction_to_Macro_Writing&oldid=7589>`__
            -  `Page
               information </maptool/index.php?title=Introduction_to_Macro_Writing&action=info>`__
      ...
      .. container:: portal
         ...
         .. container:: body
            ...
            -  `français <http://lmwcs.com/rptools/wiki/Introduction_to_Macro_Writing/fr>`__
            -  `italiano <http://lmwcs.com/rptools/wiki/Introduction_to_Macro_Writing/it>`__
            -  `日本語 <http://lmwcs.com/rptools/wiki/Introduction_to_Macro_Writing/ja>`__
            -  `한국어 <http://lmwcs.com/rptools/wiki/Introduction_to_Macro_Writing/ko>`__

.. container::
   :name: footer

   -  This page was last modified on 1 September 2019, at 17:19.
...
.. |image0| image:: /maptool/images/thumb/7/73/Macro-panels.jpg/300px-Macro-panels.jpg
   :class: thumbimage
   :width: 300px
   :height: 318px
   :target: /rptools/wiki/File:Macro-panels.jpg
.. |image1| image:: /maptool/images/thumb/f/f1/Tabbed-panels.jpg/300px-Tabbed-panels.jpg
   :class: thumbimage
   :width: 300px
   :height: 287px
   :target: /rptools/wiki/File:Tabbed-panels.jpg
.. |image2| image:: /maptool/images/thumb/3/33/Camp-panel-nomacros.png/300px-Camp-panel-nomacros.png
   :class: thumbimage
   :width: 300px
   :height: 287px
   :target: /rptools/wiki/File:Camp-panel-nomacros.png
.. |image3| image:: /maptool/images/thumb/b/ba/Camp-panel-rcaddnew.png/300px-Camp-panel-rcaddnew.png
   :class: thumbimage
   :width: 300px
   :height: 287px
   :target: /rptools/wiki/File:Camp-panel-rcaddnew.png
.. |image4| image:: /maptool/images/thumb/2/22/Camp-panel-newbutton.png/300px-Camp-panel-newbutton.png
   :class: thumbimage
   :width: 300px
   :height: 287px
   :target: /rptools/wiki/File:Camp-panel-newbutton.png
.. |image5| image:: /maptool/images/thumb/d/de/Camp-panel-rceditbutton.png/300px-Camp-panel-rceditbutton.png
   :class: thumbimage
   :width: 300px
   :height: 287px
   :target: /rptools/wiki/File:Camp-panel-rceditbutton.png
.. |image6| image:: /maptool/images/thumb/c/cc/Macro-editor-examplestring.png/300px-Macro-editor-examplestring.png
   :class: thumbimage
   :width: 300px
   :height: 213px
   :target: /rptools/wiki/File:Macro-editor-examplestring.png
.. |image7| image:: /maptool/images/thumb/0/01/Camp-panel-exbutton.png/300px-Camp-panel-exbutton.png
   :class: thumbimage
   :width: 300px
   :height: 287px
   :target: /rptools/wiki/File:Camp-panel-exbutton.png
.. |image8| image:: /maptool/images/thumb/a/a8/Macro-editor-rolldice.png/300px-Macro-editor-rolldice.png
   :class: thumbimage
   :width: 300px
   :height: 192px
   :target: /rptools/wiki/File:Macro-editor-rolldice.png
.. |image9| image:: /maptool/images/thumb/6/6b/Macro-editor-basiccommands.png/300px-Macro-editor-basiccommands.png
   :class: thumbimage
   :width: 300px
   :height: 207px
   :target: /rptools/wiki/File:Macro-editor-basiccommands.png
.. |image10| image:: /maptool/images/2/25/Prompt-undeclared-variable.png
   :class: thumbimage
   :width: 278px
   :height: 164px
   :target: /rptools/wiki/File:Prompt-undeclared-variable.png
