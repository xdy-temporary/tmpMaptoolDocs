...
.. container::
   ...
   .. container::
      ...
      .. container::
         ...
         -  `Log
            in </maptool/index.php?title=Special:UserLogin&returnto=Introduction+to+Lights+and+Sights>`__
      ...
      .. container::
         ...
         .. container:: vectorTabs
            ...
            -  `Page </rptools/wiki/Introduction_to_Lights_and_Sights>`__
            -  `Discussion </rptools/wiki/Talk:Introduction_to_Lights_and_Sights>`__
      ...
      .. container::
         ...
         .. container:: vectorTabs
            ...
            -  `Read </rptools/wiki/Introduction_to_Lights_and_Sights>`__
            -  `View
               source </maptool/index.php?title=Introduction_to_Lights_and_Sights&action=edit>`__
            -  `View
               history </maptool/index.php?title=Introduction_to_Lights_and_Sights&action=history>`__
   ...
   .. container::
      ...
      .. container:: portal
         ...
         .. container:: body
            ...
            -  `What links
               here </rptools/wiki/Special:WhatLinksHere/Introduction_to_Lights_and_Sights>`__
            -  `Related
               changes </rptools/wiki/Special:RecentChangesLinked/Introduction_to_Lights_and_Sights>`__
            -  `Special pages </rptools/wiki/Special:SpecialPages>`__
            -  `Printable
               version </maptool/index.php?title=Introduction_to_Lights_and_Sights&printable=yes>`__
            -  `Permanent
               link </maptool/index.php?title=Introduction_to_Lights_and_Sights&oldid=4335>`__
            -  `Page
               information </maptool/index.php?title=Introduction_to_Lights_and_Sights&action=info>`__
      ...
      .. container:: portal
         ...
         .. container:: body
            ...
            -  `español <http://lmwcs.com/rptools/wiki/Introduction_to_Lights_and_Sights/es>`__
            -  `français <http://lmwcs.com/rptools/wiki/Introduction_to_Lights_and_Sights/fr>`__
            -  `日本語 <http://lmwcs.com/rptools/wiki/Introduction_to_Lights_and_Sights/ja>`__

.. container::
   :name: footer

   -  This page was last modified on 12 August 2010, at 08:05.
...
.. |image1| image:: /maptool/images/thumb/f/fa/cprops-sighttab.png/300px-cprops-sighttab.png
   :class: thumbimage
   :width: 300px
   :height: 286px
   :target: /rptools/wiki/File:cprops-sighttab.png
.. |image2| image:: /maptool/images/thumb/6/6e/Cprops-lighttab.png/300px-Cprops-lighttab.png
   :class: thumbimage
   :width: 300px
   :height: 286px
   :target: /rptools/wiki/File:Cprops-lighttab.png
.. |image3| image:: /maptool/images/thumb/f/f4/Token-config-sight.png/300px-Token-config-sight.png
   :class: thumbimage
   :width: 300px
   :height: 275px
   :target: /rptools/wiki/File:Token-config-sight.png
.. |image4| image:: /maptool/images/thumb/5/5b/Token-config-light.png/300px-Token-config-light.png
   :class: thumbimage
   :width: 300px
   :height: 223px
   :target: /rptools/wiki/File:Token-config-light.png
.. |image5| image:: /maptool/images/thumb/f/fe/Map-vision-mode.png/300px-Map-vision-mode.png
   :class: thumbimage
   :width: 300px
   :height: 223px
   :target: /rptools/wiki/File:Map-vision-mode.png
.. |image6| image:: /maptool/images/thumb/5/58/Nofog-sight-boundary.png/300px-Nofog-sight-boundary.png
   :class: thumbimage
   :width: 300px
   :height: 202px
   :target: /rptools/wiki/File:Nofog-sight-boundary.png
.. |image7| image:: /maptool/images/thumb/c/c3/Nofog-sight-boundvbl.png/300px-Nofog-sight-boundvbl.png
   :class: thumbimage
   :width: 300px
   :height: 202px
   :target: /rptools/wiki/File:Nofog-sight-boundvbl.png
.. |image8| image:: /maptool/images/thumb/4/42/Nofog-visionoff-gmview.png/300px-Nofog-visionoff-gmview.png
   :class: thumbimage
   :width: 300px
   :height: 202px
   :target: /rptools/wiki/File:Nofog-visionoff-gmview.png
.. |image9| image:: /maptool/images/thumb/7/7d/Nofog-visionoff-plyrview.png/300px-Nofog-visionoff-plyrview.png
   :class: thumbimage
   :width: 300px
   :height: 202px
   :target: /rptools/wiki/File:Nofog-visionoff-plyrview.png
.. |image10| image:: /maptool/images/thumb/1/12/Nofog-visionday-gmview.png/300px-Nofog-visionday-gmview.png
   :class: thumbimage
   :width: 300px
   :height: 202px
   :target: /rptools/wiki/File:Nofog-visionday-gmview.png
.. |image11| image:: /maptool/images/thumb/8/80/Nofog-visionday-plyrview.png/300px-Nofog-visionday-plyrview.png
   :class: thumbimage
   :width: 300px
   :height: 202px
   :target: /rptools/wiki/File:Nofog-visionday-plyrview.png
.. |image12| image:: /maptool/images/thumb/b/b4/Nofog-visionnight-gmview.png/300px-Nofog-visionnight-gmview.png
   :class: thumbimage
   :width: 300px
   :height: 202px
   :target: /rptools/wiki/File:Nofog-visionnight-gmview.png
.. |image13| image:: /maptool/images/thumb/6/69/Nofog-visionnight-plyrview.png/300px-Nofog-visionnight-plyrview.png
   :class: thumbimage
   :width: 300px
   :height: 202px
   :target: /rptools/wiki/File:Nofog-visionnight-plyrview.png
.. |image14| image:: /maptool/images/thumb/d/d8/Nofog-visionnight-plyrview-candle.png/300px-Nofog-visionnight-plyrview-candle.png
   :class: thumbimage
   :width: 300px
   :height: 202px
   :target: /rptools/wiki/File:Nofog-visionnight-plyrview-candle.png
