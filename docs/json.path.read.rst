...
.. container::
   ...
   .. container::
      ...
      .. container::
         ...
         -  `Log
            in </maptool/index.php?title=Special:UserLogin&returnto=json.path.read>`__
      ...
      .. container::
         ...
         .. container:: vectorTabs
            ...
            -  `Page </rptools/wiki/json.path.read>`__
            -  `Discussion </maptool/index.php?title=Talk:json.path.read&action=edit&redlink=1>`__
      ...
      .. container::
         ...
         .. container:: vectorTabs
            ...
            -  `Read </rptools/wiki/json.path.read>`__
            -  `View
               source </maptool/index.php?title=json.path.read&action=edit>`__
            -  `View
               history </maptool/index.php?title=json.path.read&action=history>`__
   ...
   .. container::
      ...
      .. container:: portal
         ...
         .. container:: body
            ...
            -  `What links
               here </rptools/wiki/Special:WhatLinksHere/json.path.read>`__
            -  `Related
               changes </rptools/wiki/Special:RecentChangesLinked/json.path.read>`__
            -  `Special pages </rptools/wiki/Special:SpecialPages>`__
            -  `Printable
               version </maptool/index.php?title=json.path.read&printable=yes>`__
            -  `Permanent
               link </maptool/index.php?title=json.path.read&oldid=7602>`__
            -  `Page
               information </maptool/index.php?title=json.path.read&action=info>`__

.. container::
   :name: footer

   -  This page was last modified on 11 September 2019, at 15:15.
