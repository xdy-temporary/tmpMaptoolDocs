...
.. _new_concept_string_lists_and_string_properties:
...
.. _count_over_and_over_and_over_and...:
...
a count loop. This variable is called [[roll.count\| happen, and display
the result in chat; if is *not* greater than 0, then the loop will be
halted. The output of this macro looks like:
...
.. _for_i_couldnt_think_of_anything_catchy:
...
.. _example_2_creating_a_table_with_multiple_rows:
...
.. _example_1_listing_the_contents_of_a_string_list:
...
.. _example_2_attacking_a_bunch_of_bad_guys:
